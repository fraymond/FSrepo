  ...
  <el-dialog
    ...
    <el-form :model="dataForm" ref="dataForm" label-width="150px">
      <el-table :data="dataList" border v-loading="dataListLoading" style="width: 100%;">
        <el-table-column prop="cmcName" header-align="center" align="center" width="" label="币种名称" sortable></el-table-column>        
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        // 发起请求
        API.userManagement.getYhdzInfo(params).then(({data}) => {
          console.log(data)
          // 请求成功
          if (data && data.code === 0) {
            // 赋值操作
