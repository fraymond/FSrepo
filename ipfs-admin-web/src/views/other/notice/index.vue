<template>
  ...
  <div class="mod-user">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <!-- 标题 -->
      <el-table-column prop="cmcTitle" header-align="center" align="center" label="标题"></el-table-column>
      <!-- 内容 -->
      <el-table-column prop="cmcContent" header-align="center" align="center" label="内容"></el-table-column>      
      <!-- 发布时间 -->
      <el-table-column prop="cmcTime" header-align="center" align="center" width="" label="发布时间"></el-table-column>
      <!-- 状态 -->
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        // 发起请求
        API.other.noticeList(params).then(({data}) => {
          // 请求成功
          if (data && data.code === 0) {
            // 赋值操作
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${userIds.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          // 确定删除
          API.other.noticeDel(userIds).then(({data}) => {
            if (data && data.code === 0) {
              this.$message({
                message: '操作成功',
                type: 'success',
